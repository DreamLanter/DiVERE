...
<li>所有调整都会实时预览</li>
<li>使用 Ctrl+V 可以快速重置所有参数</li>
<li>使用空格键可以执行AI自动校色</li>
<li>支持全角和半角括号进行旋转操作</li>
    ...
    def _populate_shortcuts(self):
        ...
        shortcuts_data = [
            ...
            # 精细调整
            ("Ctrl/Cmd + Q", "R通道精细降曝光", "精细调整红色通道 (-0.001)"),
            ("Ctrl/Cmd + E", "R通道精细增曝光", "精细调整红色通道 (+0.001)"),
            ("Ctrl/Cmd + A", "B通道精细降曝光", "精细调整蓝色通道 (-0.001)"),
            ("Ctrl/Cmd + D", "B通道精细增曝光", "精细调整蓝色通道 (+0.001)"),
            ("Ctrl/Cmd + W", "精细降低最大密度", "精细调整整体曝光 (-0.001)"),
            ("Ctrl/Cmd + S", "精细增大最大密度", "精细调整整体曝光 (+0.001)"),
            ("Ctrl/Cmd + R", "精细增加密度反差", "精细调整对比度 (+0.001)"),
            ("Ctrl/Cmd + F", "精细降低密度反差", "精细调整对比度 (-0.001)"),
            
            # AI校色功能
            ("空格", "AI校色一次", "执行一次自动色彩校正"),
            ("Shift + 空格 (macOS)", "AI校色多次", "执行多次迭代自动色彩校正 (macOS)"),
            ("Ctrl + 空格 (Windows/Linux)", "AI校色多次", "执行多次迭代自动色彩校正 (Windows/Linux)"),
...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr><td class="shortcut">Shift + 空格 (macOS)</td><td>AI校色多次</td><td>执行多次迭代自动色彩校正</td></tr>
            <tr><td class="shortcut">Ctrl + 空格 (Windows/Linux)</td><td>AI校色多次</td><td>执行多次迭代自动色彩校正</td></tr>
        </table>
    </div>
